...
next_action: Execute only the bounded-smoke runner generated after this authorization checkpoint passes Rules CI. Keep Account ID/API token local and enter them only through the runner's hidden prompts.
