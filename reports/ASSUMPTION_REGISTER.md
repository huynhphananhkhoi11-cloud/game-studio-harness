...
| ID | Assumption | Source | Risk | Playtest question |
|---|---|---|---|---|
| ASSUMP-001 | Initial status/money values in `balance_v0.json`/`initial_state.json`. | GDD v22 direction, no playtest | Slice too easy/hard | Can players continue day 1-18? |
| ASSUMP-002 | Action costs, recovery and XP values. | Prototype tuning | Grind/fatigue mismatch | Is nine-canh planning readable? |
